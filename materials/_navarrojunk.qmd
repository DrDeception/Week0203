...
This material started out as a chapter in the ground-breaking "Learning Statistics with R" by the legendary Danielle Navarro https://learningstatisticswithr.com/ and we will be drawing upon it extensively in the future. This content is remixed from chapter 6 - Drawing Graphs by Dr. Gordon Wright, and is primarily edited down to remove some excellent content that didn't initially fit with the story I'm telling in the lecture hall and to use some data that are more familiar to us at Goldsmiths after last week. It will make a return at a later date. Thanks for leading the way, Dani! 

This material is published under a Creative Commons BY-SA license (CC BY-SA) version 4.0. This means that this book can be reused, remixed, retained, revised and redistributed (including commercially) as long as appropriate credit is given to the authors. If you remix, or modify the original version of this open textbook, you must redistribute all versions of this open textbook under the same license - CC BY-SA.
...
knitr::include_graphics("materials/images/boxplot1_annotated.png")
```
...
```{r echo=FALSE}
load(file.path("materials/data/aflsmall2.Rdata"))
```
...
load(file.path("materials/data/parenthood.Rdata"))
