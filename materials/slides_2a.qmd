...
[Hans Rosling - Joy of Stats 5 mins](https://youtu.be/jbkSRLYSojo)

[Hans Rosling TED Talk 20 mins](https://www.ted.com/talks/hans_rosling_shows_the_best_stats_you_ve_ever_seen?utm_source=tedcomshare&utm_medium=referral&utm_campaign=tedspread)

[Gapminder Website](https://www.gapminder.org/)

## My quick effort last night
...
[Visual Vocabulary](https://ft-interactive.github.io/visual-vocabulary/) (best to right-click and open in a new window)
...
::: tiny
**Categorical Data** - Nominal (e.g., types of therapy, animal species) - Ordinal (e.g., Likert scales, levels of education)

**Continuous Data** - Interval (e.g., temperature, time of day) - Ratio (e.g., height, reaction time)

**Discrete vs Continuous** - The difference between countable categories and measurements with infinite possible values.
:::
...
::::: columns
::: {.column width="40%"}
![](/images/HistogramBig.png){width="100%"}
:::
...
::::: columns
::: {.column width="40%"}
![](/images/ScatterPlotBig.png){width="100%"}
:::
...
::::: columns
::: {.column width="40%"}
![](/images/DensityBig.png){width="100%"}
:::
...
::::: columns
::: {.column width="40%"}
![](/images/ViolinBig.png){width="100%"}
:::
...
## **Design Principles for Effective Data Visualizations 1**

**Clarity and Simplicity** Avoid unnecessary elements (e.g., chartjunk, 3D effects). Focus on the key message and make the visualization intuitive to interpret. **Consistency** Use consistent colors, fonts, and labels across different graphs.

## **Design Principles for Effective Data Visualizations 2**

**Labeling and Annotations** Clear axis titles, units, and legends to make the graph self-explanatory. **Color Choices** Consider color blindness (red-green blindness common) and use color schemes that enhance readability.

## **Design Principles for Effective Data Visualizations 3**

**Appropriate Scale** Avoid misleading visuals by ensuring that scales are not exaggerated or compressed. **Hierarchy and Focus** Guide the viewer’s attention to the most important parts of the graph (using size, bolding, or contrasting colors). **Telling a Story** Visuals should flow logically and lead the reader through the narrative of your data.

## **How to Choose the Right Graph for Your Data**

**Understanding Your Audience** Tailor complexity based on who is consuming the data (public, peers, experts). **Data-Driven Decision Making** Choose the graph based on the data structure and the key message you want to convey. **Avoid Common Pitfalls** Misleading graphs (incorrect scales, truncated axes) can misinform rather than clarify. Overcomplicating simple messages with too many visual elements or excessive detail.

## **Psychological Aspects of Data Visualization**

**Cognitive Load** Minimizing mental effort required to interpret visuals. **Gestalt Principles of Perception** How humans perceive visual elements (e.g., proximity, similarity, closure) and how to leverage these in visual design. **Emotional Impact of Visuals** Using visual design to invoke emotions (e.g., empathy, urgency), particularly in health or social psychology data.

## **Examples and Case Studies**

**Good vs Bad Visualizations** Comparing effective vs poorly designed graphs. Examples from psychological research where data visualizations impacted understanding. **Interactive Exercise** Students create their own data visualization using sample datasets (e.g., reaction times, Likert scale responses).
