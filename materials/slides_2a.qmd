...
## What do you currently use to calculate?
...
<br>Quarto has support for multiple languages including R, Python, Julia, and Observable.

<br>It also works for a range of output formats such as PDFs, HTML documents, websites, presentations,...
